...
const groups = [
  {
    ...
    themeColor: '#3b82f6', 
    hardware: 'STM32L432',
    scores: { ai: 92, teacher: 88, peer: 90, total: 90 },
  ...
  },
  {
    ...
    themeColor: '#ef4444', 
    hardware: 'STM32L432',
    scores: { ai: 78, teacher: 85, peer: 83, total: 82 },
  ...
  },
  {
    ...
    themeColor: '#f59e0b', 
    hardware: 'STM32L432',
    scores: { ai: 85, teacher: 88, peer: 85, total: 86 },
  ...
  },
  {
    ...
    themeColor: '#8b5cf6', 
    hardware: 'STM32L432',
    scores: { ai: 88, teacher: 93, peer: 92, total: 91 },
