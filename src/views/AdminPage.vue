        ...
        <div :key="activeCategory" class="w-full bg-[#161a1f]/60 backdrop-blur-xl border border-white/5 rounded-3xl p-10 min-h-[400px] shadow-2xl relative overflow-hidden">
          ...
          <div class="flex items-end justify-between mb-8 border-b border-white/10 pb-6">
            <div>
              ...
              <p class="text-gray-500 mt-1 text-[15px]">共找到 {{ currentPages.length }} 个相关页面</p>
            </div>
...
const otherPages = [
  ...
  { name: '学情诊断报告', path: '/student-diagnostic-report-demo', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  ...
  { name: '教师诊断报告', path: '/teacher-diagnostic-report', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
...
const navigateTo = (path) => {
  if (path.endsWith('.html')) {
    const basePath = '/edu/case-teaching/resource/llmops'
